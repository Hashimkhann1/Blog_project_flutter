...
class GetDataThroughStream extends StatefulWidget {
  const GetDataThroughStream({Key? key}) : super(key: key);

  @override
  State<GetDataThroughStream> createState() => _GetDataThroughStreamState();
}

class _GetDataThroughStreamState extends State<GetDataThroughStream> {
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: Align(alignment: Alignment.topRight, child: AppText(text: 'Pubish on Oct 16',textSize: 17.0,textFontWeight: FontWeight.w500,textColor: ColorResource.grayColor,)),
                      ),
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                CustomTextButton(btnText: 'Detail',btnTextSize: 18.0,btntextColor: ColorResource.linkblueColor,pressed: (){Navigator.push(context, MaterialPageRoute(builder: (context) => BlogDetail(blogId: snapshot.data!.docs[index].id,)));},),
                                Icon(Icons.favorite_outline,color: ColorResource.grayColor,)
                              ],
                            )
                          ],
                        ),
